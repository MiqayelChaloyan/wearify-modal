const FEMALE_IMAGES = {
    ...
    SHAPE: [
        {
            id: 0,
            source: 'https://drive.google.com/thumbnail?id=1JXCBo0gggWsZbJWUpTCGMkCzXOLbqRaO',
            title: 'RECTANGLE',
        },
        {
            id: 1,
            source: 'https://drive.google.com/thumbnail?id=1mTOmplHLOd9QAe7YutPI_0FtirEIYpnN',
            title: 'HOURGLASS',
        },
        {
            id: 2,
            source: 'https://drive.google.com/thumbnail?id=1uAGGHW1NJqNvQNy9Ax3mgcUj7vJwCD20',
            title: 'OVAL',
        },
        {
            id: 3,
            source: 'https://drive.google.com/thumbnail?id=1JeRvxBijR4-gM-anE1qY0VYiVaboNtoW',
            title: 'INVERTED TRIANGLE',
        },
        {
            id: 4,
            source: 'https://drive.google.com/thumbnail?id=1IA23b94c1AixWhK-4HbWFZmrSV9LNTLi',
            title: 'TRIANGLE',
        },
    ],
    AGE: [
...
const MALE_IMAGES = {
    ...
    SHAPE: [
        {
            id: 0,
            source: 'https://drive.google.com/thumbnail?id=1UCE6Y1FbnQKxz8Q99LqdPRAbI6r9Pg0B',
            title: 'RECTANGLE',
        },
        {
            id: 1,
            source: 'https://drive.google.com/thumbnail?id=1TEcU9XFNFk7hMWs4HC7NSQCba-s5E2kF',
            title: 'TRAPEZOID',
        },
        {
            id: 2,
            source: 'https://drive.google.com/thumbnail?id=14mvUtntlnU4-NQQ-ihGWlkYjUBAGolMB',
            title: 'INVERTED TRIANGLE',
        },
        {
            id: 3,
            source: 'https://drive.google.com/thumbnail?id=1K9dkWPqhvd-vuxeFiqnDbWsEvYA8O7Jm',
            title: 'OVAL',
        },
        {
            id: 4,
            source: 'https://drive.google.com/thumbnail?id=1QFKA4Dt3OSkJWhv6eX06oTkbDIW6GZgX',
            title: 'TRIANGLE',
        },
    ],
    AGE: [
